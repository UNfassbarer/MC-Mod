...
public class ardenimium_dragon extends EntityModel<Entity> {
	...
	public ardenimium_dragon(ModelPart root) {
		...
		this.rearlegtip1 = root.getChild("rearlegtip1");
		this.rearfoot1 = root.getChild("rearfoot1");
		this.frontleg1 = root.getChild("frontleg1");
		this.frontlegtip1 = root.getChild("frontlegtip1");
		this.frontfoot1 = root.getChild("frontfoot1");
		this.frontleg = root.getChild("frontleg");
		this.frontlegtip = root.getChild("frontlegtip");
		this.frontfoot = root.getChild("frontfoot");
		this.rearleg = root.getChild("rearleg");
		this.rearlegtip = root.getChild("rearlegtip");
		this.rearfoot = root.getChild("rearfoot");
